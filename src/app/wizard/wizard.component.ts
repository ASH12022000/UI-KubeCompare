...
import { LucideAngularModule, Server, Target, CheckSquare, BarChart3, ChevronRight, ChevronLeft, Globe, Terminal, Loader2, Search, X } from 'lucide-angular';
...
export class WizardComponent {
  ...
  globalConnectionType: 'DIRECT' | 'JUMP' = 'JUMP';

  readonly icons = { Server, Target, CheckSquare, BarChart3, ChevronRight, ChevronLeft, Globe, Terminal, Loader2, Search, X };
  ...
  setConnectionType(type: 'DIRECT' | 'JUMP') {
